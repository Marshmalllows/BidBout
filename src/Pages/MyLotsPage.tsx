                ...
                >
                  ...
                  <div className="p-3 flex flex-row items-center justify-between gap-3">
                    <div className="flex flex-col w-full gap-2 overflow-hidden">
                      <div className="h-5 bg-gray-300 w-3/4 rounded-sm" />
                      <div className="h-3 bg-gray-300 w-1/2 rounded-sm" />
                    </div>
                    <div className="flex flex-col items-end pl-3 border-l border-gray-100 min-w-max gap-1">
                      <div className="h-3 bg-gray-300 w-10 rounded-sm" />
                      <div className="h-6 bg-gray-300 w-14 rounded-sm" />
                    </div>
                  </div>
